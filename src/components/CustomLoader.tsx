"use client";
import React, { useEffect as useEffectReact, useState } from "react";
...
export const CustomLoader = ({
  ...
  return (
    <motion.div
      className="fixed pointer-events-none p-2 border-0 shadow-2xl rounded-2xl w-fit h-fit bg-white/15 backdrop-blur-sm"
      style={{
